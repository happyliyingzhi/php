  ...
  <nav class="navbar navbar-default">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <form class="navbar-form navbar-left" style="margin:0" role="search" action="./search.php" method="get">
          <div class="form-group">
            <input type="text" class="form-control" placeholder="Search" name="hero">
          </div>
      ...
      ?>
        ...
        <tr>
          ...
          <td>
            ...
            <a href="./falsedalete.php?id=<?php  echo $v['id'] ?>" class="btn btn-md btn-danger">删除</a>
          </td>
            <?php   }  ?>
        </tr>
<!--        <tr>-->
