...
//        var_dump($link);
        //查询sql语句
        $sql="select * from hero where isDel=2";
        //执行sql语句
      ...
      <tbody>
        <tr>
          ...
          <td>
            <a href="./return.php?return=<?php echo $v['id']?>" class="btn btn-md btn-info">还原</a>
            <a href="./turedel.php?del=<?php echo $v['id']?>" class="btn btn-md btn-danger">粉碎</a>
          </td>
        </tr>
        <?php  }?>
