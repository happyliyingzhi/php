...
//         var_dump($link);
        //查询sql语句
        $sql='select * from hero where id='.$update;
        //执行sql语句
...
//        var_dump($res);
      ...
      <form action="doupdate.php" method="post" enctype="multipart/form-data">
        ...
        <div class="input-group">
          ...
          <input type="text" name='heroSkill' value="<?php echo $v['heroSkill']?>" class="form-control" placeholder="请输入技能名" aria-describedby="basic-addon2" required>
        </div>
        <div class="input-group">
