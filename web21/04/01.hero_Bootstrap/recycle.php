...
//      var_dump($link);
      // 查询sql语句
      $sql='select * from hero where isDel=2 order by id DESC ';
      //执行sql语句
...
//      var_dump($res);
      ...
      ?>
        ...
        <tr>
          ...
          <td>
            <a href="./return.php? id=<?php  echo $v['id']?>" class="btn btn-md btn-info">还原</a>
            <a href="./truedel.php?del=<?php  echo $v['id']?>" class="btn btn-md btn-danger">粉碎</a>
          </td>
        </tr>
      <?php  } ?>
<!--        <tr>-->
